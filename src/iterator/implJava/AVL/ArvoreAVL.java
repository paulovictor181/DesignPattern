...
import iterator.implJava.IteradorEmOrdem;
import iterator.implJava.IteradorPosOrdem;
import iterator.implJava.IteradorPreOrdem;

import java.util.Iterator;

public class ArvoreAVL<T> implements Iterable<T> {
    ...
    public Iterable<T> posOrdem() {
        return new Iterable<T>() {
            @Override
            public Iterator<T> iterator() {
                return new IteradorPosOrdem<>(raiz);
            }
        };
    }
